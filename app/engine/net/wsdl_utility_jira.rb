...
class WSDLUtilJira
  ...
  #
  # @param parsed_wsdl - An object of WSDLParser (@see wsdl_parser.rb)
  #-------------------------------------------------------------------------------------------------------------------
  ...
  #-------------------------------------------------------------------------------------------------------------------
  # Returns an array of the base message data types
  ...
  #-------------------------------------------------------------------------------------------------------------------
  # Returns true is the type was found to be of the XML schema type
  # typically defined by: http://www.w3.org/2001/XMLSchema
  #-------------------------------------------------------------------------------------------------------------------
  ...
  #-------------------------------------------------------------------------------------------------------------------
  # Removes namespace prefix if any and returns the stripped name.
  #
  # @param name - The name of the element to remove namespace if it exist (ie: xsd:name => name)
  #-------------------------------------------------------------------------------------------------------------------
  ...
  #-------------------------------------------------------------------------------------------------------------------
  # Loads all the base elements from the type map and returns a map of the
  #
  # @param name_sought - The name of the type whose base elements will be returned.
  #-------------------------------------------------------------------------------------------------------------------
    ...
    @parsed_wsdl.bindings.each do |binding|
      ...
      child_bindings.each do |child_binding|
        ...
        if child_binding['element_name'] =~ /operation/
          ...
          p operation_name if operation_name == "createProject"
          ...
          p next_nodes.inspect if operation_name == "createProject"
          input['headers'] = []
