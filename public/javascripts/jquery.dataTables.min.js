...
(function(i, wa, p) {
    ...
    i.fn.dataTable = function(g) {
        function l() {
            ...
            this.sInstance =
                    this.oInstance = null;
            this.oFeatures = {bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bSortMulti:true,bStateSave:false,bServerSide:false,bDeferRender:false};
        ...
        function ga(a, b, c, d) {
            i(b).bind("click.DT", function(f) {
                if (a.aoColumns[c].bSortable !== false) {
                    var e = function() {
                        var h,j;
                        if (f.shiftKey && a.oFeatures.bSortMulti) {
