...
ActiveRecord::Schema.define(:version => 20120127204410) do
  ...
  create_table "integer_properties", :force => true do |t|
  ...
  create_table "scan_summaries", :force => true do |t|
    t.text     "host"
    t.integer  "site_id"
    t.integer  "scan_id"
  ...
  create_table "soap_ticket_configs", :force => true do |t|
    t.text "mappings"
  end
